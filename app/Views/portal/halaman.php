...
<body>
    ...
    <div style="margin-top: -700px;" class="pull-top-530px sm-pull-top-0px">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-6">
                    <div style="margin-bottom: 100px;" class="icon-text layout-6 wow flipInX">
                        ...
                        <form action="<?php echo base_url('/proses') ?>" method="post" class="row g-3">
                            <div class="col-md-4">
                        ...
                        <!-- <form action="/proses-nomor-wa" method="post">
                            <input type="hidden" name="id_kuesioner" value="<?= $kuesioner['id_kuesioner']; ?>">
