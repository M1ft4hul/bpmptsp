        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-6">
                    <div style="margin-bottom: 150px;" class="icon-text layout-6 wow flipInX">
                        <h4>
                            <b> KUESIONER <br>
                        ...
                        <div class="garis"></div>
                        <form action="<?php echo base_url('/add/kuesioner') ?>" class="row" method="post" id="nameform">
                            <div class="col">
                                <div class="row">
                            ...
                            <div class="container">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-inline">
                                                <input style="width: 30px; height: 30px;" class="form-check-input" type="checkbox" name="" id="inlineCheckbox2" value="PNS">
                                                <label class="form-check-label" for="inlineCheckbox2">PNS</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input style="width: 30px; height: 30px;" class="form-check-input" type="checkbox" name="" id="inlineCheckbox2" value="TNI">
                                                <label class="form-check-label" for="inlineCheckbox2">TNI</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input style="width: 30px; height: 30px;" class="form-check-input" type="checkbox" name="" id="inlineCheckbox2" value="POLRI">
                                                <label class="form-check-label" for="inlineCheckbox2">POLRI</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input style="width: 30px; height: 30px;" class="form-check-input" type="checkbox" name="" id="inlineCheckbox2" value="SWASTA">
                                                <label class="form-check-label" for="inlineCheckbox2">SWASTA</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input style="width: 30px; height: 30px;" class="form-check-input" type="checkbox" name="" id="inlineCheckbox2" value="WIRAUSAHA">
