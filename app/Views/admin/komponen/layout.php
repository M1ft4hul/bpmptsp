<?php echo $this->include('admin/komponen/head') ?>
...
<body data-typography="poppins" data-theme-version="light" data-layout="vertical" data-nav-headerbg="black" data-headerbg="color_1">
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        <!--**********************************
            Header start
        ***********************************-->
        <?php echo $this->include('admin/komponen/header') ?>
        ...
        ***********************************-->
        ...
        <!--**********************************
            Sidebar start
        ***********************************-->
        <?php echo $this->include('admin/komponen/menu') ?>
        ...
        ***********************************-->
        ...
        <!--**********************************
            Footer start
        ***********************************-->
        <?php echo $this->include('admin/komponen/footer') ?>
        <!--**********************************
            Footer end
        ***********************************-->
    ...
    ***********************************-->
    <!-- Required vendors -->
    <?php echo $this->include('admin/komponen/script') ?>