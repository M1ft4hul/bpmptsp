<div class="deznav">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li>
                <a href="<?php echo base_url('/admin') ?>" class="" aria-expanded="false">
                    <div class="menu-icon">
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="<?php echo base_url('/admin/gallery') ?>">Upload Gallery</a></li>
                </ul>
            </li>
            ...
            <li>
                <a href="<?php echo base_url('/admin/data_sop') ?>" class="" aria-expanded="false">
                    ...
                    <span class="nav-text">Data SOP</span>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url('/admin/berita') ?>" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span class="nav-text">Upload Berita</span>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url('/admin/kuesioner') ?>" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                    ...
                    <span class="nav-text">Pengaturan Perizinan</span>
                </a>
                <ul aria-expanded="false">
                    <li><a href="<?php echo base_url('/admin/jenis_perizinan') ?>">Data Perizinan</a></li>
                    <li><a href="<?php echo base_url('/admin/jenis_sektor') ?>">Data Sektor</a></li>
                </ul>
            </li>
