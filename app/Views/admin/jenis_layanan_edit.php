                    ...
                    <div class="basic-form">
                        <form method="POST" action="/perizinanUpdate/<?= $perizinan['id_perizinan']; ?>" class="form-valide-with-icon needs-validation" novalidate>
                            <div class="mb-3 row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" value="<?= (old('nama_sektor')) ? old('nama_sektor') : $perizinan['nama_sektor'] ?>" class="form-control <?= (service('request')->getMethod(true) == 'POST' && service('validation')->hasError('nama_sektor')) ? 'is-invalid'  : ''; ?>" name="nama_sektor" id="validationCustom01" placeholder="Masukkan Nama Sektor">
