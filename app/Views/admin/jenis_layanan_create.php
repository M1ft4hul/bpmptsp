        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add Jenis Perizinan</h4>
                ...
                <div class="card-body">
                    ...
                    <div class="basic-form">
                        <form action="<?php echo base_url('/admin/perizinan/store') ?>" method="post" class="form-valide-with-icon needs-validation" novalidate>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" value="<?= old('nama_perizinan') ?>" class="form-control <?= (service('request')->getMethod(true) == 'POST' && service('validation')->hasError('nama_perizinan')) ? 'is-invalid'  : ''; ?>" name="nama_perizinan" id="validationCustom01" placeholder="Masukkan Layanan Perizinan">
