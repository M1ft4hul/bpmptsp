        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add Data Sektor</h4>
                ...
                <div class="card-body">
                    ...
                    <div class="basic-form">
                        <form action="<?php echo base_url('/admin/sektor/store') ?>" method="post" class="form-valide-with-icon needs-validation" novalidate>
                            <div class="mb-3 row">
                                <label class="col-lg-3 col-form-label" for="validationCustom01">Nama Sektor
                                    <span class="text-danger">*</span>
                                </label>
                                <div class="col-lg-6">
                                    <input type="text" value="<?= old('nama_sektor') ?>" class="form-control <?= (service('request')->getMethod(true) == 'POST' && service('validation')->hasError('nama_sektor')) ? 'is-invalid'  : ''; ?>" name="nama_sektor" id="validationCustom01" placeholder="Masukkan Sektor Baru">
