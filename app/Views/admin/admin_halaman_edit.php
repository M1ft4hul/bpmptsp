        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Form Update Isi Halaman</h4>
                ...
                <div class="card-body">
                    ...
                    <div class="basic-form">
                        <form action="/halamanUpdate/<?= $halaman['id_halaman']; ?>" method="post" class="form-valide-with-icon needs-validation" novalidate enctype="multipart/form-data">
                            <div class="mb-3 row">
                                <label class="col-lg-3 col-form-label" for="validationCustom01">Nama Halaman
                                </label>
                                <div class="col-lg-6">
                                    <input type="text" value="<?= $halaman['nama_halaman'] ?>" class="form-control <?= (service('request')->getMethod(true) == 'POST' && service('validation')->hasError('nama_halaman')) ? 'is-invalid'  : ''; ?>" name="nama_halaman" id="validationCustom01" placeholder="Masukkan nama halaman">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-lg-9 form-material">
                                    <textarea name="isi_halaman" class="form-control <?= (service('request')->getMethod(true) == 'POST' && service('validation')->hasError('isi_halaman')) ? 'is-invalid'  : ''; ?>" id="ckeditor"><?= $halaman['isi_halaman'] ?></textarea>
