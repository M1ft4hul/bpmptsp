            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="basic-form">
                        <form action="<?php echo base_url('/admin/berita/store') ?>" method="post" class="form-valide-with-icon needs-validation" novalidate enctype="multipart/form-data">
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-lg-6">
                                    <textarea name="judul" class="form-control <?= (service('request')->getMethod(true) == 'POST' && service('validation')->hasError('judul')) ? 'is-invalid'  : ''; ?>" id="validationCustom01"><?= old('judul') ?></textarea>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-lg-9 form-material">
                                    <textarea name="konten" class="form-control <?= (service('request')->getMethod(true) == 'POST' && service('validation')->hasError('konten')) ? 'is-invalid'  : ''; ?>" id="ckeditor"><?= old('konten') ?></textarea>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" value="<?= old('author') ?>" class="form-control <?= (service('request')->getMethod(true) == 'POST' && service('validation')->hasError('author')) ? 'is-invalid'  : ''; ?>" name="author" id="validationCustom01" placeholder="Masukkan Penulis Berita">
