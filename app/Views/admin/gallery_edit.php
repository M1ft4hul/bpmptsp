            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="basic-form">
                        <form method="POST" action="/galleryUpdate/<?= $gallery['id']; ?>" class="form-valide-with-icon needs-validation" novalidate enctype="multipart/form-data">
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-lg-6">
                                    <textarea name="keterangan" class="form-control <?= (service('request')->getMethod(true) == 'POST' && service('validation')->hasError('keterangan')) ? 'is-invalid'  : ''; ?>" id="validationCustom01"><?= $gallery['keterangan'] ?></textarea>
