            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="basic-form">
                        <form action="<?php echo base_url('/admin/gallery/store') ?>" method="post" class="form-valide-with-icon needs-validation" novalidate enctype="multipart/form-data">
                            <div class="mb-3 row">
                                <label class="col-lg-3 col-form-label" for="category_id">Pilih Kategori (select one):</label>
                                <div class="col-lg-6">
                            ...
                            <div class="mb-3 row">
                                <label class="col-lg-3 col-form-label" for="validationCustom01">Keterangan</label>
                                <div class="col-lg-6">
                                    <textarea name="keterangan" class="form-control <?= (service('request')->getMethod(true) == 'POST' && service('validation')->hasError('keterangan')) ? 'is-invalid'  : ''; ?>" id="validationCustom01"><?= old('keterangan') ?></textarea>
                                    <?php if (session()->getFlashdata('errors') !== null && array_key_exists('keterangan', session()->getFlashdata('errors'))) : ?>
                                        <p class="text-danger">
                            ...
                            <a href="<?php echo base_url('/admin/gallery') ?>" class="btn btn-danger light">Kembali</a>
                        </form>
                    </div>
                </div>
            </div>
